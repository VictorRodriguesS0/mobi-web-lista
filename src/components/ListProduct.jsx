...
const ListProduct = (props) => {
  ...
  const sectionFilteredList = productList.filter((product) =>
    section === "all" ? true : product.categoria === section
  );
    ...
    <div>
      <div className="my-3 d-flex flex-row justify-content-around">
        {/* <button
          ...
          style={{
            backgroundColor:
              viewMode === "list" ? colors.roxoEscuro : "transparent",
            border: "2px solid",
        ...
        >
          <i className="fas fa-stream mr-2" style={{ fontSize: 17 }} />
          Lista
        </button> */}
        ...
        <button
          ...
          style={{
            backgroundColor:
              viewMode === "gallery" ? colors.roxoEscuro : "transparent",
            border: "2px solid",
            borderColor: colors.roxoEscuro,
            borderRadius: 5,
            fontSize: 20,
